...
function UploadFacePage() {
  ...
  function handleSubmit(e) {
    ...
    alert("Foto wajah berhasil diunggah.");
    ...
    <div style={styles.page}>
      ...
      <section style={styles.right}>
        <div style={styles.formWrapper}>
          <button style={styles.backButton} onClick={() => navigate("/upload-ktp")}>
            ← Kembali
          </button>

          <h2 style={styles.title}>Verifikasi Wajah</h2>

          <p style={styles.subtitle}>
            Unggah foto wajah yang terlihat jelas, tidak blur, dan tidak menggunakan masker.
          </p>

          <form onSubmit={handleSubmit} style={styles.form}>
            <label htmlFor="face-upload" style={styles.uploadBox}>
              {preview ? (
                <img src={preview} alt="Preview Wajah" style={styles.previewImage} />
              ) : (
                <div style={styles.uploadContent}>
                  <div style={styles.faceCircle}>🙂</div>
                  <h3 style={styles.uploadTitle}>Ketuk untuk unggah foto wajah</h3>
                  <p style={styles.uploadText}>Format JPG atau PNG. Maks. 5MB</p>
                </div>
              )}
            ...
            <div style={styles.tipsBox}>
              <h4 style={styles.tipsTitle}>Tips Verifikasi Wajah</h4>
              <ul style={styles.tipsList}>
                <li>Gunakan pencahayaan yang cukup</li>
                <li>Pastikan wajah terlihat jelas</li>
                <li>Hindari masker atau kacamata hitam</li>
                <li>Gunakan foto terbaru dan tidak blur</li>
              </ul>
            </div>
