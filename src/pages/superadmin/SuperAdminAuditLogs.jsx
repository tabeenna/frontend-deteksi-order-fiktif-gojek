    ...
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'Inter', 'Segoe UI', Arial, sans-serif", background: "#F0F0EB" }}>
      ...
      <aside style={{ width: 240, background: "#1C1C1C", position: "fixed", top: 0, left: 0, height: "100vh", display: "flex", flexDirection: "column", zIndex: 100 }}>
        ...
        <div style={{ padding: "0 12px 24px" }}>
          <button
            style={{ display: "flex", alignItems: "center", gap: 10, width: "100%", padding: "10px 14px", borderRadius: 9, background: "transparent", color: "#888", border: "none", cursor: "pointer", fontSize: 14 }}
      ...
      <main style={{ marginLeft: 240, flex: 1, display: "flex", flexDirection: "column", minHeight: "100vh" }}>
        ...
        <header style={{ background: "white", borderBottom: "1px solid #E8E8E3", padding: "0 28px", height: 60, display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 50 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#F5F5F0", borderRadius: 24, padding: "8px 16px", width: 220 }}>
            ...
            <input
              placeholder="Search"
              style={{ border: "none", background: "transparent", outline: "none", fontSize: 13.5, color: "#333", width: "100%" }}
            />
          </div>
        ...
        <div style={{ padding: "28px 28px 48px", flex: 1 }}>
          ...
          <div style={{ background: "white", borderRadius: 14, border: "1px solid #EBEBEB", boxShadow: "0 1px 3px rgba(0,0,0,0.04)", overflow: "hidden" }}>
            ...
            <div style={{ padding: "16px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid #F0F0EB" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                  <span style={{ width: 8, height: 8, borderRadius: "50%", background: "#00AA13", display: "inline-block" }} />
                  <span style={{ fontSize: 12, fontWeight: 700, color: "#00AA13", letterSpacing: "0.2px" }}>LIVE UPDATES ON</span>
                </div>
              </div>
            ...
            {/* Column headers */}
            <div style={{ display: "grid", gridTemplateColumns: "200px 1fr 160px 1fr 120px 60px", padding: "10px 24px", background: "#FAFAF8", borderBottom: "1px solid #F0F0EB" }}>
              {["TIMESTAMP", "ADMIN / USER ID", "ACTION TYPE", "ENTITY MODIFIED", "LOCATION", "DETAILS"].map(h => (
            ...
            {AUDIT_LOGS.map((row, i) => {
              ...
              return (
                <div
                  ...
                  style={{
                    display: "grid",
                    gridTemplateColumns: "200px 1fr 160px 1fr 120px 60px",
                    padding: "18px 24px",
                    alignItems: "center",
                ...
                >
                  ...
                  {/* Entity Modified */}
                  <div style={{ fontSize: 13.5, color: "#555" }}>{row.entity}</div>
                  ...
                  <div style={{ display: "flex", justifyContent: "center" }}>
                    <button
                      style={{ background: "none", border: "none", cursor: "pointer", padding: 4, borderRadius: 6, display: "flex", alignItems: "center", color: "#CCC" }}
                      onMouseEnter={e => e.currentTarget.style.color = "#555"}
                      onMouseLeave={e => e.currentTarget.style.color = "#CCC"}
                    >
                      <SvgIcon name="info" size={18} color="currentColor" />
                    </button>
                  </div>
                </div>
              );
