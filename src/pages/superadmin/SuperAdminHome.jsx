          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 28 }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 16 }}>
                ...
                <span style={{ fontSize: 12, fontWeight: 700, color: "rgba(255,255,255,0.85)", letterSpacing: "0.5px" }}>USER ACCOUNTS</span>
              </div>
              <h3 style={{ margin: "0 0 8px", fontSize: 28, fontWeight: 800, color: "white" }}>38,204 Low Risk</h3>
              <p style={{ margin: "0 0 24px", fontSize: 14, color: "rgba(255,255,255,0.8)", lineHeight: 1.5, flex: 1 }}>
                User accounts currently on low risk status. No immediate action required.
              </p>
              {/* Progress bar */}
              <div>
                <div style={{ height: 6, borderRadius: 99, background: "rgba(255,255,255,0.25)", overflow: "hidden" }}>
                  <div style={{ width: "90%", height: "100%", background: "white", borderRadius: 99 }} />
                </div>
                <div style={{ textAlign: "right", fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.7)", marginTop: 6, letterSpacing: "0.5px" }}>90% OF TOTAL USERS</div>
              </div>
            </div>
          </div>
